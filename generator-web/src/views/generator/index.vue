<template>
  <div class="app-container">
    ...
    <div class="head-container">
      <el-input v-model="query.name" clearable placeholder="请输入表名" style="width: 200px;" class="filter-item"
...
export default {
  ...
  methods: {
    parseTime,
    beforeInit () {
      this.url = 'api/generator/getTables'
      const query = this.query
      const name = query.name
      const start = this.page + 1
      this.params = {start: start, limit: this.size}
      if (name) {
